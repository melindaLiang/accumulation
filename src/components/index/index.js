    ...
    activeRoute(val) {
      ...
      switch (val.name) {
        ...
        case 'aboutVue':
          ...
          break;
        case 'vueModifier':
          this.active_menu_home = 'vueModifier';
          window.localStorage.setItem('active_menu_home', 'vueModifier');
          this.current_open_menu = 'aboutVue';
          break;
        case 'aboutAxios':
          this.active_menu_home = 'aboutAxios';
          window.localStorage.setItem('active_menu_home', 'aboutAxios');
          this.current_open_menu = 'aboutVue';
          break;
        default:
